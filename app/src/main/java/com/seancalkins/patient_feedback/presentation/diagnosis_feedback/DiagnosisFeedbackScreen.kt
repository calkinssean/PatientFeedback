package com.seancalkins.patient_feedback.presentation.diagnosis_feedback
...
fun DiagnosisFeedbackScreen(
    ...
    val textState = remember { mutableStateOf(viewModel.diagnosisFeedback) }
    ...
    Scaffold(
        ...
        content = {
            Column(
                ...
                Text(
                    text = "We appreciate the feedback, one last question: how do you feel about being diagnosed with ${viewModel.diagnosis}?",
                ...
                RoundedButton(
                    ...
                    text = "Next",
                    onTapped = {
                        viewModel.diagnosisFeedback = textState.value
                        onNextTapped()
                    }
                )
            }
